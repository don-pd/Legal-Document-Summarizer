...
SERVICE_ACCOUNT_FILE = r"C:\Users\donpd\Desktop\legal sum\client.json"
...
EMAIL_API_URL = os.getenv("EMAIL_API_URL")  # Email service API URL
EMAIL_API_KEY = os.getenv("EMAIL_API_KEY")  # Email service API key
...
def perform_analysis(pdf_text):
    ...
    # Load risk analysis DataFrame from a valid JSON file
    risks_df = pd.read_json("Risk_assessment.json")  # Save JSON file in correct format
...
def upload_to_google_sheets(df):
    ...
    spreadsheet_body = {"properties": {"title": "Legal Document Analysis"}}
